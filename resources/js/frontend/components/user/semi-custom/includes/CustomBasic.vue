    ...
    <div>
        <div class="relative min-h-svh">
            <div class="flex justify-between items-center bg-primary-50 p-6 lg:px-14 lg:py-7">
                <div class="font-bold text-white text-lg lg:text-xl uppercase tracking-widest">CUSTOM MADE SHIRT</div>
            </div>
            ...
            <div>
                ...
                <div class="flex items-center gap-12 mx-20 my-10">
                    <div class="font-bold text-primary-50 text-xs 2xl:text-lg uppercase tracking-widest">OPTION NUMBER</div>
                    ...
                    <div class="grid grid-cols-2 my-10 px-6 lg:px-10 xl:px-14">
                        <div v-for="frontBody in dataCustomShirt.front_body.data.basic">
                            ...
                            <label class="flex flex-col justify-between items-center gap-4 px-2 rounded h-full cursor-pointer" :for="'front-body-' + frontBody.slug">
                                ...
                                <div class="font-bold text-primary-50 text-xs 2xl:text-lg text-center uppercase tracking-widest">{{ frontBody.name }}</div>
                                <span class="checkbox-inner"></span>
                            </label>
                        </div>
                    </div>
                        ...
                        <div>
                            ...
                            <div v-for="pocket in dataCustomShirt.pocket.data.basic">
                                ...
                                <label class="flex flex-col justify-between items-center gap-4 px-2 rounded h-full cursor-pointer" :for="'pocket-'+pocket.slug">
                                    ...
                                    <div class="font-bold text-primary-50 text-xs 2xl:text-lg text-center uppercase tracking-widest">{{ pocket.name }}</div>
                                    <span class="checkbox-inner"></span>
                                </label>
                            </div>
                        </div>
                    ...
                    <div>
                        ...
                        <div v-for="hem in dataCustomShirt.hem.data.basic">
                            ...
                            <label class="flex flex-col justify-between items-center gap-4 px-2 rounded h-full cursor-pointer" :for="'hem-'+hem.slug">
                                ...
                                <div class="font-bold text-primary-50 text-xs 2xl:text-lg text-center uppercase tracking-widest">{{ hem.name }}</div>
                                <span class="checkbox-inner"></span>
                            </label>
                        </div>
                    </div>
            ...
            <div>
                ...
                <div class="grid grid-cols-4 my-8 xl:my-10 p-6 lg:px-10 xl:px-14">
                    <div v-for="backBody in dataCustomShirt.back_body.data.basic">
                        ...
                        <label class="flex flex-col justify-between items-center gap-4 px-2 rounded h-full cursor-pointer" :for="'back-body-'+backBody.slug">
                            ...
                            <div class="font-bold text-primary-50 text-xs 2xl:text-lg text-center uppercase tracking-widest">{{ backBody.name }}</div>
                            <span class="checkbox-inner"></span>
                        </label>
                    </div>
                </div>
            ...
            <div>
                ...
                <div class="gap-2 grid grid-cols-4 grid-rows-2 my-10 px-6 lg:px-10 xl:px-14">
                    <div class="max-xl:col-span-4 xl:row-span-2">
                        <div class="inline-block px-2 pt-1.5 border-2 border-primary-50 font-bold text-primary-50 text-xs 2xl:text-lg uppercase tracking-widest">BODY TYPE</div>
                    </div>
                    <div class="max-xl:col-span-2">
                        <input @click.native="formSize.bodyType = null" v-model="formSize.bodyType" value="2. SLIM" class="hidden" type="radio" name="body-type" :id="`slim`">
                        <label class="flex items-center gap-4 px-2 rounded h-full cursor-pointer" :for="`slim`">
                            <div class="font-bold text-primary-50 text-xs 2xl:text-lg text-center uppercase tracking-widest">2. SLIM</div>
                            <span class="checkbox-inner"></span>
                        </label>
                    </div>
                    <div class="max-xl:col-span-2">
                        <input @click.native="formSize.bodyType = null" v-model="formSize.bodyType" value="3. STANDARD I" class="hidden" type="radio" name="body-type" :id="`standard-1`">
                        <label class="flex items-center gap-4 px-2 rounded h-full cursor-pointer" :for="`standard-1`">
                            <div class="font-bold text-primary-50 text-xs 2xl:text-lg text-center uppercase tracking-widest">3. STANDARD I</div>
                            <span class="checkbox-inner"></span>
                        </label>
                    </div>
                    <div class="max-xl:col-span-2">
                        <input @click.native="formSize.bodyType = null" v-model="formSize.bodyType" value="4. STANDARD II" class="hidden" type="radio" name="body-type" :id="`standard-2`">
                        <label class="flex items-center gap-4 px-2 rounded h-full cursor-pointer" :for="`standard-2`">
                            <div class="font-bold text-primary-50 text-xs 2xl:text-lg text-center uppercase tracking-widest">4. STANDARD II</div>
                            <span class="checkbox-inner"></span>
                        </label>
                    </div>
                    <div class="max-xl:col-span-2">
                        <input @click.native="formSize.bodyType = null" v-model="formSize.bodyType" value="5. BIG I" class="hidden" type="radio" name="body-type" :id="`big-1`">
                        <label class="flex items-center gap-4 px-2 rounded h-full cursor-pointer" :for="`big-1`">
                            <div class="font-bold text-primary-50 text-xs 2xl:text-lg text-center uppercase tracking-widest">5. BIG I</div>
                            <span class="checkbox-inner"></span>
                        </label>
                    </div>
                    <div class="max-xl:col-span-2">
                        <input @click.native="formSize.bodyType = null" v-model="formSize.bodyType" value="7. BIG II" class="hidden" type="radio" name="body-type" :id="`big-2`">
                        <label class="flex items-center gap-4 px-2 rounded h-full cursor-pointer" :for="`big-2`">
                            <div class="font-bold text-primary-50 text-xs 2xl:text-lg text-center uppercase tracking-widest">7. BIG II</div>
                            <span class="checkbox-inner"></span>
                        </label>
                    </div>
                </div>
                ...
                <div class="gap-2 grid grid-cols-4 grid-rows-2 mt-6 px-6 lg:px-10 xl:px-14">
                    <div class="max-xl:col-span-4 xl:row-span-2">
                        <div class="inline-block px-2 pt-1.5 border-2 border-primary-50 font-bold text-primary-50 text-xs 2xl:text-lg uppercase tracking-widest">SLEEVE</div>
                    </div>
                    <div class="max-xl:col-span-2">
                        <input @click.native="formSize.sleeve = null" v-model="formSize.sleeve" value="1. SLIM SLEEVE" class="hidden" type="radio" name="sleeve" :id="`slim-sleeve`">
                        <label class="flex items-center gap-4 px-2 rounded h-full cursor-pointer" :for="`slim-sleeve`">
                            <div class="font-bold text-primary-50 text-xs 2xl:text-lg text-center uppercase tracking-widest">1. SLIM SLEEVE</div>
                            <span class="checkbox-inner"></span>
                        </label>
                    </div>
                    <div class="max-xl:col-span-2">
                        <input @click.native="formSize.sleeve = null" v-model="formSize.sleeve" value="2. REGULAR SLEEVE" class="hidden" type="radio" name="sleeve" :id="`regular-sleeve`">
                        <label class="flex items-center gap-4 px-2 rounded h-full cursor-pointer" :for="`regular-sleeve`">
                            <div class="font-bold text-primary-50 text-xs 2xl:text-lg text-center uppercase tracking-widest">2. REGULAR SLEEVE</div>
                            <span class="checkbox-inner"></span>
                        </label>
                    </div>
                </div>
            ...
            <div>
                ...
                <div class="gap-3 grid grid-cols-5 my-10 px-6 lg:px-10 xl:px-14">
                    ...
                    <div class="space-y-2 col-span-2">
                        ...
                        <!-- <input v-model="price" type="number" class="px-4 pt-2 pb-1 border-2 border-primary-50 w-full text-primary-50 number-input" placeholder="RP" /> -->
                        <VueNumber v-model.lazy="price" v-bind="number_input" class="px-4 pt-2 pb-1 border-2 border-primary-50 w-full text-primary-50 number-input" placeholder="RP"></VueNumber>

                        <div>
                            <button @click="basicAmount()" class="bg-secondary px-5 pt-3 pb-2 w-full text-primary-50 text-center">APPLY PRICE</button>
                        </div>
                    </div>
                </div>
            </div>
