    ...
    <div class="space-y-10">
                ...
                <table class="w-full" v-if="products.length !== 0">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 10%;" class="px-6 py-3 text-center uppercase text-primary-50">Coupon (%)</th>
                    ...
                    <tbody>
                        <tr class="border-b" v-for="(product, index) in products">
                            <td class="py-3 pr-6 text-left text-primary-50">
                                ...
                                <template v-if="product.product_actual_stocks">
                                    <template v-if="product.product_actual_stocks.length">
                                        <div class="my-1 text-xs text-left text-primary-300" v-for="(stock, index) in product.product_actual_stocks" :key="index">
                            ...
                            <td class="px-6 py-3 text-center text-primary-50">
                                <div class="text-center text-secondary-50 lg:text-lg">
                                    <input type="number" class="w-20 p-2 text-center border border-primary-50" v-model.lazy="product.discount" placeholder="0">
                                </div>
                            </td>
                            <td class="px-6 py-3 text-center text-primary-50">
        ...
        <section class="absolute bottom-0 w-full">
            <div class="flex justify-between">
                <button @click="addRtw()" class="flex items-center gap-2 p-4 tracking-widest text-white uppercase bg-primary-50 lg:p-6">
