...
<template>
    <div class="grid grid-cols-8">
        <div class="flex flex-col col-span-2 w-full">
            <div :class="{ 'h-full': !props.extends }" class="flex flex-col items-center sidebar" style="background-image: url('/img/bg-02.jpg');">
                <div class="border-4 border-white bg-primary-50 border-solid rounded-full overflow-hidden size-36">
