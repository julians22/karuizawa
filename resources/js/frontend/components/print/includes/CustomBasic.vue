            ...
            <div>
                ...
                <div>
                    ...
                    <div class="flex items-center gap-4 px-6 my-3 fabric-code">
                        <label for="fabric-code" class="text-sm tracking-widest uppercase whitespace-nowrap text-primary-50">fabric code</label>
...
<style lang="scss" scoped>
    .wrap-cat{
        @apply flex items-center justify-between px-4 py-1 bg-primary-300;
