        ...
        <div class="gap-6 grid grid-cols-2">
            <div>
                ...
                <div class="mt-2">
                 ...
                 <div class="flex items-center gap-2 bg-secondary mx-6 mt-4 p-4">
...
<style lang="scss" scoped>
    ...
    .label-name {
        @apply font-bold text-center text-primary-50 text-xs print:text-base uppercase tracking-wider;
    }
