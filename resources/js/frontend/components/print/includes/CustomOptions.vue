                        ...
                        <div class="flex self-end gap-2 justify-self-end">
                            ...
                            <div class="self-end">
                                ...
                                <label class="flex items-center h-full gap-4 px-2 rounded cursor-pointer" :for="`cleric-50rb`">
                                    <!-- <div class="text-xs font-bold tracking-wider text-center uppercase text-pink-ka xl:text-sm print:text-base">{{ currencyFormat(dataConfig[0].price) }}</div> -->
                                </label>
                            </div>
                        </div>
                    </div>
                                   ...
                                   <div class="flex w-full gap-4">
                                       ...
                                       <div class="whitespace-nowrap">
                                           ...
                                           <label class="flex items-center h-full gap-4 px-2 rounded cursor-pointer" :for="`embroidery-50rb`">
                                               <div class="text-xs font-bold tracking-wider text-center uppercase text-pink-ka xl:text-sm print:text-base">{{ currencyFormat(dataConfig.embroidery.data.options.price) }}</div>
                                               <!-- <span class="checkbox-inner pink"></span> -->
                                           </label>
                                       </div>
                                   </div>
                   ...
                   <div class="flex items-center justify-between gap-4 p-4 mx-6 mt-4 border border-pink-ka">
                       ...
                       <div class="whitespace-nowrap">
                           ...
                           <label class="flex items-center h-full gap-4 px-2 rounded cursor-pointer font-roboto" :for="`sewing-200rb`">
                               <div class="text-xs font-bold tracking-wider text-center uppercase text-pink-ka xl:text-sm print:text-base"> {{ currencyFormat(formOption.tape.price ?? 200000)  }} </div>
                               <!-- <span class="checkbox-inner pink"></span> -->
                           </label>
                       </div>
                   </div>
                            ...
                            <div class="col-span-2 space-y-2">
                                <div>
                                    ...
                                    <VueNumber v-model="discount" v-bind="number_input"
                                            class="w-full px-4 pt-2 pb-1 border border-pink-ka text-primary-50 number-input"></VueNumber>
                                </div>
                                <div>
...
<style lang="scss" scoped>
    ...
    .label-name {
        @apply text-xs print:text-base font-bold tracking-wider text-center uppercase text-primary-50;
    }
