<script setup>
    ...
    const isChecked = (a) => {
        formOption.value.cleric.data.forEach(element => {
            if (element.slug === a) {
                console.log(true);
                return 1
                        ...
                        <div v-for="(subCeleric, index) in dataCleric" :key="index" class="flex gap-2">
                            ...
                            <div class="flex gap-2 checkbox-cleric" :class="{ 'pointer-events-none': formOption.cleric?.slug != subCeleric.slug}">
                                <div v-for="(clericItems, index) in subCeleric.data">
                                    <div>
                                        <input :checked="isChecked(clericItems.slug)" class="hidden" type="checkbox" :id="`cleric-${subCeleric.no}-${clericItems.slug}`">
                ...
                <div class="mt-2">
                   ...
                   <div class="mx-2 mt-4 space-y-4 border border-pink-ka">
                       <div class="grid grid-cols-3">
                           <!-- position -->
                           <div class="p-2 space-y-2 border-b border-r border-b-dashed border-pink-ka">
                           ...
                           <!-- color -->
                           <div class="p-2 space-y-2 border-b border-l border-r border-b-dashed border-pink-ka">
                           ...
                           <!-- font type -->
                           <div class="p-2 space-y-2 border-b border-b-dashed border-pink-ka">
...
<style lang="scss" scoped>
    .wrap-opt-cat{
        @apply flex items-center justify-between px-4 py-1 bg-blue-ka;
