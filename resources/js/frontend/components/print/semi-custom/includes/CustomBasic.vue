        ...
        <div class="gap-6 grid grid-cols-2">
            <div>
                ...
                <div>
                    ...
                    <div class="flex items-center gap-4 my-3 px-2 fabric-code print-props">
                        <label for="fabric-code" class="text-primary-50 text-sm uppercase tracking-widest whitespace-nowrap">fabric code</label>
                        <InputBox :inputValue="form.fabric.fabricCode" />
                        <input v-model="form.fabric.text" type="text" class="block p-2 border border-primary-50 border-r w-full h-8 font-roboto text-gray-900 text-sm">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-6 my-4 px-2">
                        <div v-for="collar in props.dataConfig.collar.data.basic">
                            <input @click.native="form.collar = null" class="hidden" type="radio" v-model="form.collar" :value="collar" :id="'collar-' + collar.slug">
                            <label class="flex flex-col justify-between items-center gap-2 px-2 rounded h-full cursor-pointer" :for="'collar-' + collar.slug">
                    ...
                    <div class="flex items-center gap-4 mx-10 my-3">
                        <div class="font-bold text-primary-50 text-xs uppercase tracking-widest">OPTION NUMBER</div>
                        <div class="flex font-roboto print-props">
                            <InputBox :digitCount="2" :inputValue="form.collar?.optionNumber" />
                        </div>
                    </div>
                </div>
                ...
                <div class="gap-4 grid grid-cols-2">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-3 my-4 px-2">
                            <div v-for="cuff in props.dataConfig.cuffs.data.basic">
                                <input @click.native="form.cuff = null" class="hidden" type="radio" v-model="form.cuff" :value="cuff" :id="'cuff-' + cuff.slug">
                                <label class="flex flex-col justify-between items-center gap-2 px-2 rounded h-full cursor-pointer" :for="'cuff-' + cuff.slug">
                        ...
                        <div class="flex items-center gap-2 my-4 px-2">
                            <div class="font-bold text-primary-50 text-xs uppercase tracking-widest">OPTION NUMBER</div>
                            <div class="flex font-roboto print-props">
                                <InputBox :digitCount="2" :inputValue="form.cuff?.optionNumber" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 my-4 px-2">
                            <div v-for="frontBody in props.dataConfig.front_body.data.basic">
                                <input @click.native="form.frontBody = null" class="hidden" type="radio" v-model="form.frontBody" :value="frontBody" :id="'front-body-' + frontBody.slug">
                                <label class="flex flex-col justify-between items-center gap-2 px-2 rounded h-full cursor-pointer" :for="'front-body-' + frontBody.slug">
                        ...
                        <div class="flex items-center gap-2 my-4 px-2">
                            <div class="font-bold text-primary-50 text-xs uppercase tracking-widest">OPTION NUMBER</div>
                            <div class="flex font-roboto print-props">
                                <InputBox :digitCount="2" :inputValue="form.frontBody?.optionNumber" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <!-- pocket -->
                        <div>
                            ...
                            <div class="grid grid-cols-3 my-4 px-4">
                            <div v-for="pocket in props.dataConfig.pocket.data.basic">
                                <input @click.native="form.pocket = null" class="hidden" type="radio" v-model="form.pocket" :value="pocket" :id="'pocket-'+pocket.slug">
                ...
                <!-- hem -->
                    <div>
                        ...
                        <div class="grid grid-cols-2 my-4 px-4">
                            <div v-for="hem in props.dataConfig.hem.data.basic">
                                <input @click.native="form.hem = null" class="hidden" type="radio" v-model="form.hem"  :value="hem" :id="'hem-'+hem.slug">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-4 my-4">
                        <div v-for="backBody in props.dataConfig.back_body.data.basic">
                            <input @click.native="form.backBody = null" class="hidden" type="radio" v-model="form.backBody" :value="backBody" :id="'back-body-'+backBody.slug">
            ...
            <div>
                ...
                <div>
                    ...
                    <div class="gap-2 grid grid-cols-5 my-2 px-2">
                        <div v-for="button in props.dataConfig.button.data.basic">
                            <input @click.native="form.button = null" class="hidden" type="radio" :id="`button-${button.slug}`" v-model="form.button" :value="button">
                ...
                <div>
                    ...
                    <div class="gap-2 grid grid-cols-3 mb-2 px-2">
                        <div>
                            <input v-model="formSize.order" class="hidden" value="1. NEW ORDER" type="radio" :id="`new-order`">
                        ...
                        <div class="">
                            <input v-model="formSize.order" class="hidden" type="radio" value="2. REPEAT ORDER" :id="`repeat-order`">
                        ...
                        <div>
                            <input v-model="formSize.order" class="hidden" type="radio" value="3. GARMENT SAMPLE" :id="`garment-sample`">
                    ...
                    <!-- body type -->
                    <div class="gap-2 grid grid-cols-4 grid-rows-2 mb-2 px-2">
                        <div class="row-span-2">
                            <div class="inline-block px-2 pt-1.5 border-2 border-primary-50 font-bold text-primary-50 text-sm uppercase tracking-widest">BODY TYPE</div>
                        </div>
                        <div class="">
                            <input v-model="formSize.bodyType" value="2. SLIM" class="hidden" type="radio" :id="`slim`">
                        ...
                        <div class="">
                            <input v-model="formSize.bodyType" value="3. STANDARD I" class="hidden" type="radio" :id="`standard-1`">
                        ...
                        <div class="">
                            <input v-model="formSize.bodyType" value="4. STANDARD II" class="hidden" type="radio" :id="`standard-2`">
                        ...
                        <div class="">
                            <input v-model="formSize.bodyType" value="5. BIG I" class="hidden" type="radio" :id="`big-1`">
                        ...
                        <div class="">
                            <input v-model="formSize.bodyType" value="7. BIG II" class="hidden" type="radio" :id="`big-2`">
                        ...
                        <div class="">
                            <input v-model="formSize.bodyType" value="3. STANDARD II" class="hidden" type="radio" :id="`standard-3`">
                    ...
                    <!-- sleeve -->
                    <div class="gap-2 grid grid-cols-4 grid-rows-0 px-2">
                        <div class="row-span-2">
                            <div class="inline-block px-2 pt-1.5 border-2 border-primary-50 font-bold text-primary-50 text-sm uppercase tracking-widest">SLEEVE</div>
                        </div>
                        <div class="">
                            <input v-model="formSize.sleeve" value="1. SLIM SLEEVE" class="hidden" type="radio" :id="`slim-sleeve`">
                        ...
                        <div class="">
                            <input v-model="formSize.sleeve" value="2. REGULAR SLEEVE" class="hidden" type="radio" :id="`regular-sleeve`">
                    ...
                    <div class="px-2">
                            ...
                            <table class="w-full text-primary-50">
                                ...
                                <tbody>
                                    <tr class="*:border-2 *:border-primary-50 *:text-center">
                                        <td>SHIRT</td>
                                        <td>
                                            <input v-model="formSize.shirt.neck" type="text" class="w-full font-roboto text-center print-props">
                                        </td>
                                        <td>
                                            <input v-model="formSize.shirt.rightSleeve" type="text" class="w-full font-roboto text-center print-props">
                                        </td>
                                        <td>
                                            <input v-model="formSize.shirt.leftSleeve" type="text" class="w-full font-roboto text-center print-props">
                                        </td>
                                        <td>
                                            <input v-model="formSize.shirt.chest" type="text" class="w-full font-roboto text-center print-props">
                                        </td>
                                        <td>
                                            <input v-model="formSize.shirt.waist" type="text" class="w-full font-roboto text-center print-props">
                                        </td>
                                        <td>
                                            <input v-model="formSize.shirt.shoulder" type="text" class="w-full font-roboto text-center print-props">
                                        </td>
                                    </tr>
                                    <tr class="*:border-2 *:border-primary-50 *:text-center">
                                        <td>ACTUAL</td>
                                        <td>
                                            <input v-model="formSize.actual.neck" type="text" class="w-full font-roboto text-center print-props">
                                        </td>
                                        <td>
                                            <input v-model="formSize.actual.rightSleeve" type="text" class="w-full font-roboto text-center print-props">
                                        </td>
                                        <td>
                                            <input v-model="formSize.actual.leftSleeve" type="text" class="w-full font-roboto text-center print-props">
                                        </td>
                                        <td>
                                            <input v-model="formSize.actual.chest" type="text" class="w-full font-roboto text-center print-props">
                                        </td>
                                        <td>
                                            <input v-model="formSize.actual.waist" type="text" class="w-full font-roboto text-center print-props">
                                        </td>
                                        <td>
                                            <input v-model="formSize.actual.shoulder" type="text" class="w-full font-roboto text-center print-props">
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                        ...
                        <div class="grid grid-cols-3 grid-rows-2 mt-2 mb-2 *:px-2 *:pt-2 *:pb-1 text-primary-50 tracking-widest whitespace-pre">
                            <div class="border-2 border-primary-50">SPECIAL ADJUSTMENT</div>
                            <div class="flex border-primary-50 border-y-2">
                                <div>NECK SIZE :</div>
                                <div>
                                    <input v-model="formSize.sa.neckSize" type="text" class="w-full font-roboto text-center print-props">
                                </div>
                            </div>
                            <div class="flex border-primary-50 border-x-2 border-y-2">
                                <div>SHOULDER :</div>
                                <div>
                                    <input v-model="formSize.sa.shoulder" type="text" class="w-full font-roboto text-center print-props">
                                </div>
                            </div>
                            <div class="flex col-start-3 border-primary-50 border-x-2 border-b-2">
                                <div>BACK LENGTH :</div>
                                <div>
                                    <input v-model="formSize.sa.backLength" type="text" class="w-full font-roboto text-center print-props">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="mb-0">
                    ...
                    <div class="gap-3 grid grid-cols-5 my-4 px-2">
                        <div class="col-span-6">
                            <textarea v-model="additionalNote" class="p-2 border-2 border-primary-50 w-full h-full font-roboto placeholder:font-josefin print:text-2xl placeholder:tracking-widest placeholder-primary-50" id="" placeholder="NOTE"></textarea>
                        </div>
                        <div class="col-span-5 bg-secondary p-2 w-full">
                            <div class="w-full">
                                <div class="text-primary-50 text-sm uppercase tracking-widest">Total price</div>
                                <div class="items-center grid grid-cols-[repeat(27,1fr)] w-full text-center uppercase">
                                    <div class="flex flex-col col-span-6 bg-white border-2 border-primary-50">
                                        <div class="bg-primary-50 py-0.5 text-white text-sm text-center">price</div>
                                    ...
                                    <div class="flex flex-col col-span-6 bg-white border-2 border-primary-50">
                                        <div class="bg-primary-50 py-0.5 text-white text-sm text-center">option</div>
                                    ...
                                    <div class="col-span-1">+</div>
                                    <div class="flex flex-col col-span-6 bg-white border-2 border-primary-50">
                                        <div class="bg-primary-50 py-0.5 text-white text-sm text-center">delivery cost</div>
                                        <div class="flex justify-center items-center px-2 py-1 h-14">
                                            <div></div>
                                        </div>
                                    </div>
                                    <div class="col-span-1">=</div>
                                    <div class="flex flex-col col-span-6 bg-white border-2 border-primary-50">
                                        <div class="bg-primary-50 py-0.5 text-white text-sm text-center">total</div>
                                        <div class="flex justify-center items-center px-2 py-1 h-14">
                                            <div></div>
                                        </div>
                                    </div>
                            ...
                            <div class="gap-2 grid grid-cols-5 mt-2">
                                <div class="col-span-3">
                                    ...
                                    <table>
                                        <thead class="text-sm text-left uppercase">
                                            <tr class="*:px-2 *:pt-2 *:pb-1 *:border-primary-50 *:border-x">
                                                <th>Name</th>
                                ...
                                <div class="flex flex-col justify-between col-span-2 uppercase">
                                    <div class="flex flex-col col-span-6 bg-white border-2 border-primary-50">
                                        <div class="bg-primary-50 py-0.5 text-white text-sm text-center">customer sign</div>
                                        <div class="flex justify-center items-center px-2 py-1 h-16 print:h-24">
                                            <div></div>
                                        </div>
                                    </div>
                                    <div class="flex flex-col col-span-6 bg-white border-2 border-primary-50">
                                        <div class="bg-primary-50 py-0.5 text-white text-sm text-center">store sign</div>
                                        <div class="flex justify-center items-center px-2 py-1 h-16 print:h-24">
...
<style lang="scss" scoped>
    ...
    .label-name {
        @apply font-bold text-primary-50 text-xs print:text-xl text-center uppercase tracking-widest;
    }
