                   ...
                   <div class="flex items-center justify-between gap-4 p-4 mx-2 mt-4 border border-pink-ka">
                       ...
                       <div class="whitespace-nowrap">
                           ...
                           <label class="flex items-center h-full gap-4 px-2 rounded cursor-pointer font-roboto" :for="`sewing-200rb`">
                               <div class="text-xs font-bold tracking-wider text-center uppercase text-pink-ka print:text-base xl:text-sm"> {{ currencyFormat(tape.price ?? 200000)  }} </div>
                               <!-- <span class="checkbox-inner pink"></span> -->
                           </label>
                       </div>
                   </div>
               ...
               <div class="mt-2 m">
                   ...
                   <div class="grid grid-cols-6 gap-3 px-2 mt-2">
                        <div class="col-span-6">
                            <textarea class="w-full h-full p-2 border border-primary-50 font-roboto placeholder:font-josefin placeholder:tracking-widest placeholder-primary-50" v-model="additionalNote" id="" placeholder="NOTE"></textarea>
                        </div>
                        <div class="col-span-6">
