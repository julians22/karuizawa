            ...
            <div>
                                ...
                                <div class="self-end col-span-2 justify-items-end">
                                    <div class="">
                                        ...
                                        <label class="flex items-center h-full gap-4 px-2 rounded cursor-pointer" :for="`50rb`">
                                            <div class="text-xs font-bold tracking-wider text-center uppercase text-pink-ka xl:text-sm print:text-base">
                ...
                <div class="flex gap-4 *:w-full">
                    <div class="">
                        ...
                        <div class="flex justify-between p-2 mt-4 ml-2 border max-xl:mx-2 max-xl:mb-4 border-pink-ka">
                    ...
                    <div class="">
                        ...
                        <div class="flex justify-between p-2 mt-4 mr-2 border max-xl:mx-2 border-pink-ka">
                       ...
                       <div class="buttons-wrapper">
                           <div class="buttons-layout">
                               <div class="flex" v-for="(buttonHole, index) in dataConfig.button_hole.data.options.option_1" :key="index">
                                   ...
                                   <label class="flex items-center h-full rounded cursor-pointer gap-x-2" :for="`botton-hole-${buttonHole.slug}`">
                                       <span class="checkbox-inner"></span>
                            ...
                            <div class="col-span-3 p-4">
                                <div class="flex items-end gap-4">
                                    <div class="flex items-end font-roboto print-props-embroidery">
                                        ...
                                        <input v-model="embroidery.initialName.dot" type="text" maxlength="1" class="block w-8 h-6 text-sm text-center text-gray-900 border-primary-50 border-y">
                                    ...
                                    <div class="flex w-full gap-4 print-props-embroidery">
                                        <input type="text" v-model="embroidery.longName" class="block w-full h-8 p-2 text-sm text-gray-900 border border-primary-50 font-roboto print-props">
                                        <div class="whitespace-nowrap">
                                            ...
                                            <label class="flex items-center h-full gap-4 px-2 rounded cursor-pointer" :for="`embroidery-50rb`">
                                                <div class="text-xs font-bold tracking-wider text-center uppercase text-pink-ka xl:text-sm">{{ currencyFormat(props.dataConfig.embroidery.data.options.price) }}</div>
                                                <!-- <span class="checkbox-inner pink"></span> -->
                                            </label>
                                        </div>
                                    </div>
                       ...
                       <div class="flex items-center justify-between w-full p-4 border border-pink-ka">
                           ...
                           <div class="whitespace-nowrap">
                               ...
                               <label class="flex items-center h-full gap-4 px-2 rounded cursor-pointer" :for="`interlining-100rb`">
                                   <div class="text-xs font-bold tracking-wider text-center uppercase text-pink-ka xl:text-sm print:text-base">{{ currencyFormat(dataConfig.interlining.data.options.option_2[0].price) }} </div>
                                   <!-- <span class="checkbox-inner pink"></span> -->
                               </label>
                           </div>
                       </div>
                       ...
                       <div v-for="(sewing, index) in dataConfig.sewing_option.data.options" :key="index" class="flex items-center justify-between w-full p-4 border border-pink-ka">
                           ...
                           <div class="whitespace-nowrap">
                               ...
                               <label class="flex items-center h-full gap-4 px-2 rounded cursor-pointer" :for="`sewing-100rb`">
                                   <div class="text-xs font-bold tracking-wider text-center uppercase text-pink-ka xl:text-sm print:text-base"> {{ currencyFormat(dataConfig.sewing_option.data.options[index][0].price) }}</div>
                                   <!-- <span class="checkbox-inner pink"></span> -->
                               </label>
                           </div>
                       </div>
                   ...
                   <div class="flex items-center justify-between gap-4 p-4 mx-2 mt-4 border border-pink-ka">
                       ...
                       <div class="whitespace-nowrap">
                           ...
                           <label class="flex items-center h-full gap-4 px-2 rounded cursor-pointer font-roboto" :for="`sewing-200rb`">
                               <div class="text-xs font-bold tracking-wider text-center uppercase text-pink-ka xl:text-sm print:text-base"> {{ currencyFormat(tape.price ?? 200000)  }} </div>
                               <!-- <span class="checkbox-inner pink"></span> -->
                           </label>
                       </div>
                   </div>
               ...
               <div class="mt-2 m">
                   ...
                   <div class="grid grid-cols-6 gap-3 px-2 mt-2">
                        <div class="col-span-6">
                            <textarea class="w-full h-full p-2 border border-primary-50 font-roboto placeholder:font-josefin placeholder:tracking-widest placeholder-primary-50 print:text-2xl" v-model="additionalNote" id="" placeholder="NOTE"></textarea>
                        </div>
                        <div class="col-span-6">
