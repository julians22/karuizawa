...
@section('content')
    <div class="home_hero">
        <img class="w-full" src="{{ asset('img/home/img-hero.jpg') }}" alt="">
    </div>
                          ...
                          <div class="splide__list">
                                @for ($i = 0; $i < 6; $i++)
                                    <div class="splide__slide aspect-[9/11]">
                                        <div class="relative w-full h-full bg-center bg-no-repeat bg-cover" style="background-image: url('{{ asset('img/home/collection-0'. ($i + 1) . '.jpg') }}');">
                                            <div class="absolute inset-x-0 -translate-y-1/2 top-1/2">
                                                <div class="mx-auto w-fit">
                                                    <div class="text-xl font-medium tracking-widest text-white uppercase">Shirt</div>
