                ...
                <x-frontend.card>
                    ...
                    <x-slot name="body">
                        ...
                        <div class="tab-content" id="my-profile-tabsContent">
                            <div class="pt-3 tab-pane fade show active" id="my-profile" role="tabpanel" aria-labelledby="my-profile-tab">
                                @include('frontend.user.account.tabs.profile')
                            </div><!--tab-profile-->

                            <div class="pt-3 tab-pane fade" id="information" role="tabpanel" aria-labelledby="information-tab">
                            ...
                            <div class="pt-3 tab-pane fade" id="two-factor-authentication" role="tabpanel" aria-labelledby="two-factor-authentication-tab">
